...
int Modulationfrequency = 30; // Set modulation frequency
#define Frequencyratio 100 // Set ratio between modulation and carrier frequency 
int Carrierfrequency = Modulationfrequency * Frequencyratio; // and calculate carrier frequency
...
void setup() {
  ...
  pinMode(3, OUTPUT);
  pinMode(4, OUTPUT);
  // Calculate voltages for triangular wave
